...
| `el-briefing.jpg` | El informe con banderas rojas | ancho ≥ 1000 px | pendiente |
| `el_opener.jpg` | Panel con grupo y encuentro cargados | ancho ≥ 1000 px | pendiente |
| `el_combatplan` | Plan de combate con contingencias | ancho ≥ 1000 px | pendiente |
